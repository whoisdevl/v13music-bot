...
class Collection {
    ...
    */
    math(key, operator, value, goToNegative = false) {
        if (!/^-?\d+$/.test(`${value}`))
            throw Error((0, util_js_1.formatErrorMessage)("Invlid Type Value", 'Collection', 'Method', "math"));
        if (!`${operator}`.match(/(\-|\+|\/|\*)/g))
            throw Error((0, util_js_1.formatErrorMessage)("Invlid Type Operator", 'Collection', 'Method', "math"));
        if (typeof goToNegative != "boolean")
            throw Error((0, util_js_1.formatErrorMessage)("Invlid Type goToNegative", 'Collection', 'Method', "math"));
        if (!this.has(key)) {
            this.set(key, value);
        }
        else {
    ...
    */
    findIndex(key) {
        return this.toArray().findIndex(o => o[0] == key) < 0 ? 0 : this.toArray().findIndex(o => o[0] == key);
    }
    /**
    * @returns {any}
    */
